    ...
    return(
        <ContainerMainContatos >
            <ContainerDivH3Contatos>
             ...
             <ContainerIcons>
                <a target="_blank" rel='noreferrer noopener' href="https://www.linkedin.com/in/ernandes-bitencourt"  > <img  src={linkedininicon} alt="imagem linkedin"/></a>         
                <a target="_blank" rel='noreferrer noopener' href="https://github.com/ErnandesBitencourt" ><img src={githubicon} alt=" imagem github"/></a>
             </ContainerIcons>
          </ContainerMainContatos> 
